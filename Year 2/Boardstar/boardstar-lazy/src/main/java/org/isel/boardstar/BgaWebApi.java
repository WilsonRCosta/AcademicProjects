...
public class BgaWebApi implements BgaApi {
    ...
    public List<GameDto> searchByArtist(int pageNumber, String artist) {
        ...
        GetGamesDto getGamesDto = gson.fromJson(body, GetGamesDto.class);
        return getGamesDto.getGames();
    }
    ...
    public List<CategoryDto> getCategories() {
        ...
        Iterable<String> lines = req.getLines(path);
        String body = String.join("", lines);
        GetCategoriesDto getCategoriesDto = gson.fromJson(body, GetCategoriesDto.class);
